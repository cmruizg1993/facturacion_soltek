            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    if($method == "POST" && $empresa){
                        ...
                        $sql2 = "SELECT t.id, invoice_no, created_at, final_total FROM transactions t LEFT JOIN fe_facturas f ON t.id = f.transaction_id WHERE business_id = $empresa AND f.estado_sri = 'RECIBIDA' ORDER BY t.id DESC";
                        ...
                        while($fila2 = $resultado2->fetch_array()){
                            ...
                            echo "<tr>";
                            echo "<td><a href='./acciones/autorizar_sri.php?id=$id'>Autorizar SRI</a></td>";
                            echo "<td>$counter</td>";
